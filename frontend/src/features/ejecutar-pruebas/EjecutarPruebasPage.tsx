...
export function EjecutarPruebasPage({
  ...
  const renderInternalBugButton = (test: any, compact = false) => {
    ...
    const title = linkedBug
      ...
      : "Preparar bug interno desde la ejecucion fallida de esta build";
    return (
      <Button
              ...
              <Button
                ...
                onClick={() =>
                  showFeedback(
                    ...
                    "El contador usa el orden pasadas / fallidas / bloqueadas / sin correr. Verde: pasadas, rojo: fallidas, azul: bloqueadas, gris: sin correr.",
                    "info",
                  )
                }
              >
        ...
        <div className="p-2 overflow-auto flex-grow-1 pb-5">
          {executionInitialLoading ? (
            ...
            <div className="text-center text-muted p-3 small">
              ...
              {!currentBuildId
                ? "Seleccioná o creá una build para ver casos ejecutables."
                : !currentCompId
                  ? "Seleccioná o creá un componente para ver casos ejecutables."
                  : "La build activa no tiene casos asignados para este componente."}
            </div>
          ) : (
            <>
              {executionRefreshing && (
                  ...
                  <div className="d-flex align-items-center gap-1">
                    ...
                    >
                      <option value="all">
                        {openBugsLoading
                          ? "Cargando bugs..."
                          : `Todos (${openBugTotal} bug${openBugTotal === 1 ? "" : "s"})`}
                      </option>
                      <option value="open">
                ...
                return (
                  ...
                  >
                    ...
                    {openBugs.length > 0 && (
                      <Alert
                        variant={
                          openBugs.some(isRetestBug) ? "warning" : "danger"
                        }
                        className="py-2 px-3 x-small mb-3"
                      >
                      ...
                      <td className="text-center">
                        {trend === "up" && (
                          <div
                            ...
                            title="Mejoró respecto a ejecución anterior"
                          >
                            <div
                              style={{
                                width: "24px",
                        ...
                        {trend === "down" && (
                          <div
                            className="d-flex flex-column align-items-center"
                            title="Empeoró respecto a ejecución anterior"
                          >
                            <div
                              style={{
                                width: "24px",
            ...
            >
                  ...
                  <div className="x-small text-muted d-flex flex-column gap-1">
                    ...
                    {isOutdatedExecutionCase(selectedTest) && (
                      <div className="text-warning fw-semibold">
                        Nueva versión disponible: v{selectedTest.latestVersion}
                      </div>
                    )}
                      ...
                      <span className="d-flex align-items-center gap-1">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            showFeedback(
                              "Bugs relacionados",
                              "El contador muestra bugs asociados a este caso. Cada chip separa estado, severidad/prioridad y criticidad.",
                              "info",
                            )
                          }
                        >
              ...
              <div className="p-3 border-top bg-light d-flex flex-column gap-2">
                {isOutdatedExecutionCase(selectedTest) && (
                  ...
                  >
                    Este caso fue ejecutado como v{selectedTest.version}. Hay
                    una v{selectedTest.latestVersion}; se agregará a la build
                    antes de ejecutar.
                  </Alert>
                )}
                {canStartAnyExecution && (
