        ...
        <Row className="g-2">
          <Col md={8}>
            <Form.Group>
              ...
              <div className="input-group"><span className="input-group-text bg-secondary-subtle text-secondary fw-semibold font-monospace" title={t('casos.immutableCaseCode')}>{editingCaseCode || 'TC · al guardar'}</span><Form.Control type="text" placeholder={t('casos.caseTitlePlaceholder')} value={newTestTitle} onChange={(e) => setNewTestTitle(e.target.value)} required className="bg-light border-light-subtle shadow-none fw-bold text-primary fs-6" /></div>
            </Form.Group>
          </Col>
          <Col md={4}>
            <Form.Group>
