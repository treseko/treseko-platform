...
export function IaSchedulerModal({
  ...
  return (
    <Modal dialogClassName="ai-scheduler-modal" show={show} onHide={onHide} size="xl" centered backdrop="static" contentClassName="border-0 shadow-lg rounded-4 overflow-hidden">
      <Modal.Header closeButton closeLabel={t('motorIa.close')} className="bg-dark text-white border-0 py-3">
          ...
          <Col md={7} className="border-end border-light-subtle bg-white d-flex flex-column h-100">
            <div className="p-3 border-bottom bg-light">
              ...
              <div className="input-group input-group-sm">
                ...
                <Form.Control name="a11y-iaschedulermodaltsx-65" aria-label={t('motorIa.searchSuites')}
                  type="text"
                  ...
                  <Card key={suite.id} className="border-light-subtle shadow-sm mb-3">
                    <Card.Header className="bg-light py-2 d-flex justify-content-between align-items-center border-bottom-0">
                      <div className="d-flex align-items-center gap-2">
                        <Form.Check name="a11y-iaschedulermodaltsx-91" aria-label={t('motorIa.selectAll')}
                          type="checkbox"
                    ...
                    <ListGroup variant="flush">
                      {suiteTests.map(test => (
                        ...
                        >
                          <Form.Check name="a11y-iaschedulermodaltsx-117" aria-label={t('motorIa.selectCase')}
                            type="checkbox"
            ...
            <Card className="border-0 shadow-sm rounded-3 mb-3">
              <Card.Body className="p-3">
                <Form.Group className="mb-3">
                  ...
                  <Form.Control name="a11y-iaschedulermodaltsx-146" aria-label={t('motorIa.executionName')} type="text" size="sm" value={execName} onChange={(e) => setExecName(e.target.value)} className="bg-light fw-bold text-dark" />
                </Form.Group>
                <Form.Group>
                  ...
                  <Form.Control name="a11y-iaschedulermodaltsx-150" aria-label={t('motorIa.scheduledTime')} type="datetime-local" size="sm" value={scheduledTime} onChange={(e) => setScheduledTime(e.target.value)} className="bg-light text-dark" />
                </Form.Group>
              </Card.Body>
            </Card>
