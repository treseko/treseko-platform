      ...
      <Modal.Body>
        ...
        {target && (
          <Form.Group className="mb-3">
            ...
            <Form.Select name="a11y-bugtransitionmodaltsx-33" aria-label={t('bugs.selectBuild')} value={form.resolution_build_id} onChange={(event) => onChange({ ...form, resolution_build_id: event.target.value })}>
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control name="a11y-bugtransitionmodaltsx-42" aria-label={corrected ? t('bugs.resolution') : reopening ? t('bugs.reopeningContext') : t('bugs.closureReason')} as="textarea" rows={3} value={corrected || reopening ? form.resolucion : form.motivo_cierre}
