...
DEFAULT_AI_ENGINE_CONFIG = {
    "ai_execution_driver": "treseko_engine",
    "opencode_version": os.getenv("OPENCODE_VERSION", "1.18.5"),
    "opencode_model": None,
    "opencode_agent": None,
    "opencode_timeout_seconds": 30,
    "opencode_max_steps": 20,
    "opencode_health_status": None,
    "opencode_last_verified_at": None,
